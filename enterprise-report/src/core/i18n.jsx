...
const DICT = {
  de: {
    ...
    'nav.admin': 'Admin-Bereich', 'nav.berichtfreigabe': 'Bericht-Freigabe', 'nav.events': 'Events & Aktionen', 'nav.doku': 'Wissen & Doku', 'nav.technologie': 'Technologie & F&E', 'nav.abgrenzung': 'Abgrenzungsrechnung', 'nav.lzempfehlung': 'Lebenszyklus-Maßnahmen', 'nav.kpieditor': 'KPI-Editor (Formeln)', 'nav.nutzung': 'Nutzungs-Statistik', 'nav.lager': 'Lagerverwaltung', 'nav.wms': 'WMS (operativ)', 'nav.produktion': 'Produktionscontrolling', 'nav.planung': 'Planung (Budget/Forecast)', 'nav.szenario': 'Szenario-Simulator', 'nav.detailberichte': 'Detailberichte',
