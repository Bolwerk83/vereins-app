...
const DICT = {
  de: {
    'nav.tree': 'Berichtsbaum', 'nav.bi': 'Self-Service BI', 'nav.qc': 'Querchecks', 'nav.abstimmung': 'Abstimmbrücken', 'nav.lebenszyklus': 'Produkt-Lebenszyklus', 'nav.auftrag': 'Auftrags-Lebenszyklus', 'nav.anlagen': 'Anlagen-Lebenszyklus', 'nav.lieferant': 'Lieferanten-Lebenszyklus', 'nav.marketing': 'Marketing & Analytics',
  ...
  en: {
    'nav.tree': 'Report tree', 'nav.bi': 'Self-service BI', 'nav.qc': 'Cross-checks', 'nav.abstimmung': 'Reconciliation', 'nav.lebenszyklus': 'Product lifecycle', 'nav.auftrag': 'Order-to-cash', 'nav.anlagen': 'Asset lifecycle', 'nav.lieferant': 'Supplier lifecycle', 'nav.marketing': 'Marketing & analytics',
