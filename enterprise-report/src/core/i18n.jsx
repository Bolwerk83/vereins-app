...
const DICT = {
  de: {
    ...
    'nav.wizard': 'Wizard', 'nav.katalog': 'Katalog', 'nav.designer': 'Designer', 'nav.controlling': 'Controlling-Struktur', 'nav.klrablauf': 'KLR-Ablauf (roter Faden)', 'nav.klr': 'Kosten- & Leistungsrechnung', 'nav.einzelgemein': 'Einzel- & Gemeinkosten', 'nav.kostenstellen': 'Kostenstellenrechnung', 'nav.bab': 'Betriebsabrechnungsbogen', 'nav.kalkulation': 'Kostenträger & Kalkulation', 'nav.ergebnis': 'Ergebnisrechnung (GuV)', 'nav.rechte': 'Rollen & Rechte', 'nav.onboarding': 'Onboarding', 'nav.hilfe': 'Hilfe / So funktioniert’s', 'nav.kennzahlen': 'Kennzahlen', 'nav.zeit': 'Zeit & Datenart', 'nav.vergleich': 'Versionsvergleich', 'nav.verteiler': 'Verteiler', 'nav.abschluss': 'Abschluss & Versionen', 'nav.transport': 'Transport (dev/test/prod)',
