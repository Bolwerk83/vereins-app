...
const DICT = {
  de: {
    ...
    'nav.wizard': 'Wizard', 'nav.katalog': 'Katalog', 'nav.designer': 'Designer', 'nav.controlling': 'Controlling-Struktur', 'nav.klr': 'Kosten- & Leistungsrechnung', 'nav.einzelgemein': 'Einzel- & Gemeinkosten', 'nav.kostenstellen': 'Kostenstellenrechnung', 'nav.bab': 'Betriebsabrechnungsbogen', 'nav.rechte': 'Rollen & Rechte', 'nav.onboarding': 'Onboarding', 'nav.hilfe': 'Hilfe / So funktioniert’s', 'nav.kennzahlen': 'Kennzahlen', 'nav.zeit': 'Zeit & Datenart', 'nav.vergleich': 'Versionsvergleich', 'nav.verteiler': 'Verteiler', 'nav.abschluss': 'Abschluss & Versionen', 'nav.transport': 'Transport (dev/test/prod)',
