...
const DICT = {
  de: {
    ...
    'nav.admin': 'Admin-Bereich', 'nav.events': 'Events & Aktionen', 'nav.doku': 'Wissen & Doku', 'nav.technologie': 'Technologie & F&E', 'nav.abgrenzung': 'Abgrenzungsrechnung', 'nav.lzempfehlung': 'Lebenszyklus-Maßnahmen',
  ...
  en: {
    ...
    'nav.admin': 'Admin area', 'nav.events': 'Events & campaigns', 'nav.doku': 'Knowledge & docs', 'nav.technologie': 'Technology & R&D', 'nav.abgrenzung': 'Cost/expense reconciliation', 'nav.lzempfehlung': 'Lifecycle measures',
