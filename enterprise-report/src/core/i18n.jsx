...
const DICT = {
  de: {
    ...
    'nav.wizard': 'Wizard', 'nav.katalog': 'Katalog', 'nav.designer': 'Designer', 'nav.controlling': 'Controlling-Struktur', 'nav.klrablauf': 'KLR-Ablauf (roter Faden)', 'nav.klr': 'Kosten- & Leistungsrechnung', 'nav.einzelgemein': 'Einzel- & Gemeinkosten', 'nav.kostenstellen': 'Kostenstellenrechnung', 'nav.bab': 'Betriebsabrechnungsbogen', 'nav.kalkulation': 'Kostenträger & Kalkulation', 'nav.ergebnis': 'Ergebnisrechnung (GuV)', 'nav.db': 'Deckungsbeitragsrechnung', 'nav.rechte': 'Rollen & Rechte', 'nav.lernpfad': 'Lernpfad', 'nav.onboarding': 'Onboarding', 'nav.hilfe': 'Hilfe / So funktioniert’s', 'nav.kennzahlen': 'Kennzahlen', 'nav.zeit': 'Zeit & Datenart', 'nav.vergleich': 'Versionsvergleich', 'nav.verteiler': 'Verteiler', 'nav.abschluss': 'Abschluss & Versionen', 'nav.transport': 'Transport (dev/test/prod)',
  ...
  en: {
    ...
    'nav.wizard': 'Wizard', 'nav.katalog': 'Catalogue', 'nav.designer': 'Designer', 'nav.controlling': 'Controlling structure', 'nav.klrablauf': 'Cost accounting flow', 'nav.klr': 'Cost & activity accounting', 'nav.einzelgemein': 'Direct & overhead costs', 'nav.kostenstellen': 'Cost centre accounting', 'nav.bab': 'Cost allocation sheet', 'nav.kalkulation': 'Costing & product result', 'nav.ergebnis': 'Income statement (P&L)', 'nav.db': 'Contribution margin', 'nav.rechte': 'Roles & rights', 'nav.lernpfad': 'Learning path', 'nav.onboarding': 'Onboarding', 'nav.hilfe': 'Help / How it works', 'nav.kennzahlen': 'Metrics', 'nav.zeit': 'Time & data type', 'nav.vergleich': 'Version comparison', 'nav.verteiler': 'Distribution', 'nav.abschluss': 'Close & versions', 'nav.transport': 'Transport (dev/test/prod)',
