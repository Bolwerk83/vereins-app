...
const DICT = {
  de: {
    ...
    'nav.wizard': 'Wizard', 'nav.katalog': 'Katalog', 'nav.designer': 'Designer', 'nav.rechte': 'Rollen & Rechte', 'nav.hilfe': 'Hilfe / So funktioniert’s', 'nav.kennzahlen': 'Kennzahlen',
  ...
  en: {
    ...
    'nav.wizard': 'Wizard', 'nav.katalog': 'Catalogue', 'nav.designer': 'Designer', 'nav.rechte': 'Roles & rights', 'nav.hilfe': 'Help / How it works', 'nav.kennzahlen': 'Metrics',
