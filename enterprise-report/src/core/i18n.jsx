...
const DICT = {
  de: {
    'nav.tree': 'Berichtsbaum', 'nav.bi': 'Self-Service BI', 'nav.qc': 'Querchecks', 'nav.abstimmung': 'Abstimmbrücken', 'nav.lebenszyklus': 'Produkt-Lebenszyklus', 'nav.auftrag': 'Auftrags-Lebenszyklus', 'nav.anlagen': 'Anlagen-Lebenszyklus', 'nav.lieferant': 'Lieferanten-Lebenszyklus', 'nav.marketing': 'Marketing & Analytics', 'nav.marketingkarte': 'Marketing-Landkarten', 'nav.gutschriften': 'Gutschriften & Retouren', 'nav.vertriebkpi': 'Vertriebskennzahlen', 'nav.prozesskette': 'Prozesskette AE → Umsatz', 'nav.portfoliobcg': 'Portfolio-Matrix (BCG)', 'nav.bestand': 'Bestands-Gängigkeit', 'nav.forderungen': 'Forderungs-Aging', 'nav.mitarbeiter': 'Mitarbeiter-Lebenszyklus',
    'nav.massnahmen': 'Maßnahmen', 'nav.instrumente': 'Instrumente', 'nav.alerts': 'Alerts',
    'nav.wizard': 'Wizard', 'nav.katalog': 'Katalog', 'nav.designer': 'Designer', 'nav.controlling': 'Controlling-Struktur', 'nav.klrablauf': 'KLR-Ablauf (roter Faden)', 'nav.ablauf': 'Ablaufdiagramm', 'nav.klr': 'Kosten- & Leistungsrechnung', 'nav.einzelgemein': 'Einzel- & Gemeinkosten', 'nav.kostenstellen': 'Kostenstellenrechnung', 'nav.bab': 'Betriebsabrechnungsbogen', 'nav.profitcenter': 'Profitcenter-Ergebnis', 'nav.pckostenstellen': 'Profit-Center → Kostenstellen', 'nav.kontenstrukturen': 'Sachkonto-Strukturen', 'nav.finanzcockpit': 'Finanz- & Risiko-Cockpit', 'nav.kalkulation': 'Kostenträger & Kalkulation', 'nav.ergebnis': 'Ergebnisrechnung (GuV)', 'nav.db': 'Deckungsbeitragsrechnung', 'nav.rechte': 'Rollen & Rechte', 'nav.lernpfad': 'Lernpfad', 'nav.onboarding': 'Onboarding', 'nav.hilfe': 'Hilfe / So funktioniert’s', 'nav.kennzahlen': 'Kennzahlen', 'nav.tagesreporting': 'Tagesreporting', 'nav.quartalsbericht': 'Quartalsbericht', 'nav.kalkulatorik': 'Kalkulatorische Kosten', 'nav.zeit': 'Zeit & Datenart', 'nav.vergleich': 'Versionsvergleich', 'nav.segment': 'Segment- & Konzernbericht', 'nav.abweichung': 'Abweichungsanalyse', 'nav.abgleichabsatz': 'Abgleich Absatz ↔ AET', 'nav.verteiler': 'Verteiler', 'nav.abschluss': 'Abschluss & Versionen', 'nav.transport': 'Transport (dev/test/prod)',
    'nav.admin': 'Admin-Bereich', 'nav.events': 'Events & Aktionen', 'nav.doku': 'Wissen & Doku', 'nav.technologie': 'Technologie & F&E', 'nav.abgrenzung': 'Abgrenzungsrechnung', 'nav.lzempfehlung': 'Lebenszyklus-Maßnahmen', 'nav.kpieditor': 'KPI-Editor (Formeln)', 'nav.nutzung': 'Nutzungs-Statistik', 'nav.lager': 'Lagerverwaltung', 'nav.wms': 'WMS (operativ)', 'nav.produktion': 'Produktionscontrolling', 'nav.planung': 'Planung (Budget/Forecast)', 'nav.szenario': 'Szenario-Simulator', 'nav.detailberichte': 'Detailberichte',
  ...
  en: {
    'nav.tree': 'Report tree', 'nav.bi': 'Self-service BI', 'nav.qc': 'Cross-checks', 'nav.abstimmung': 'Reconciliation', 'nav.lebenszyklus': 'Product lifecycle', 'nav.auftrag': 'Order-to-cash', 'nav.anlagen': 'Asset lifecycle', 'nav.lieferant': 'Supplier lifecycle', 'nav.marketing': 'Marketing & analytics', 'nav.marketingkarte': 'Marketing maps', 'nav.gutschriften': 'Credit notes & returns', 'nav.vertriebkpi': 'Sales metrics', 'nav.prozesskette': 'Funnel order → revenue', 'nav.portfoliobcg': 'Portfolio matrix (BCG)', 'nav.bestand': 'Inventory turnover', 'nav.forderungen': 'Receivables aging', 'nav.mitarbeiter': 'Employee lifecycle',
    'nav.massnahmen': 'Measures', 'nav.instrumente': 'Instruments', 'nav.alerts': 'Alerts',
    'nav.wizard': 'Wizard', 'nav.katalog': 'Catalogue', 'nav.designer': 'Designer', 'nav.controlling': 'Controlling structure', 'nav.klrablauf': 'Cost accounting flow', 'nav.ablauf': 'Process diagram', 'nav.klr': 'Cost & activity accounting', 'nav.einzelgemein': 'Direct & overhead costs', 'nav.kostenstellen': 'Cost centre accounting', 'nav.bab': 'Cost allocation sheet', 'nav.profitcenter': 'Profit-centre result', 'nav.pckostenstellen': 'Profit centre → cost centres', 'nav.kontenstrukturen': 'GL account structures', 'nav.finanzcockpit': 'Financial & risk cockpit', 'nav.kalkulation': 'Costing & product result', 'nav.ergebnis': 'Income statement (P&L)', 'nav.db': 'Contribution margin', 'nav.rechte': 'Roles & rights', 'nav.lernpfad': 'Learning path', 'nav.onboarding': 'Onboarding', 'nav.hilfe': 'Help / How it works', 'nav.kennzahlen': 'Metrics', 'nav.tagesreporting': 'Daily reporting', 'nav.quartalsbericht': 'Quarterly report', 'nav.kalkulatorik': 'Imputed costs', 'nav.zeit': 'Time & data type', 'nav.vergleich': 'Version comparison', 'nav.segment': 'Segment & group report', 'nav.abweichung': 'Variance analysis', 'nav.abgleichabsatz': 'Sales vs. order intake', 'nav.verteiler': 'Distribution', 'nav.abschluss': 'Close & versions', 'nav.transport': 'Transport (dev/test/prod)',
