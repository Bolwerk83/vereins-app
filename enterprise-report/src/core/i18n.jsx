...
const DICT = {
  de: {
    'nav.tree': 'Berichtsbaum', 'nav.bi': 'Self-Service BI', 'nav.qc': 'Querchecks', 'nav.abstimmung': 'Abstimmbrücken', 'nav.lebenszyklus': 'Produkt-Lebenszyklus', 'nav.auftrag': 'Auftrags-Lebenszyklus', 'nav.anlagen': 'Anlagen-Lebenszyklus', 'nav.lieferant': 'Lieferanten-Lebenszyklus', 'nav.marketing': 'Marketing & Analytics', 'nav.marketingkarte': 'Marketing-Landkarten', 'nav.gutschriften': 'Gutschriften & Retouren', 'nav.vertriebkpi': 'Vertriebskennzahlen', 'nav.prozesskette': 'Prozesskette AE → Umsatz', 'nav.portfoliobcg': 'Portfolio-Matrix (BCG)', 'nav.versand': 'Versand-Cockpit', 'nav.bestand': 'Bestands-Gängigkeit', 'nav.forderungen': 'Forderungs-Aging', 'nav.mitarbeiter': 'Mitarbeiter-Lebenszyklus',
    ...
    'nav.admin': 'Admin-Bereich', 'nav.datenmodell': 'Datenmodell & Mapping', 'nav.datenschutz': 'Datenschutz & Sicherheit', 'nav.berichtfreigabe': 'Bericht-Freigabe', 'nav.events': 'Events & Aktionen', 'nav.doku': 'Wissen & Doku', 'nav.technologie': 'Technologie & F&E', 'nav.abgrenzung': 'Abgrenzungsrechnung', 'nav.lzempfehlung': 'Lebenszyklus-Maßnahmen', 'nav.kpieditor': 'KPI-Editor (Formeln)', 'nav.nutzung': 'Nutzungs-Statistik', 'nav.lager': 'Lagerverwaltung', 'nav.wms': 'WMS (operativ)', 'nav.produktion': 'Produktionscontrolling', 'nav.planung': 'Planung (Budget/Forecast)', 'nav.szenario': 'Szenario-Simulator', 'nav.detailberichte': 'Detailberichte',
  ...
  en: {
    'nav.tree': 'Report tree', 'nav.bi': 'Self-service BI', 'nav.qc': 'Cross-checks', 'nav.abstimmung': 'Reconciliation', 'nav.lebenszyklus': 'Product lifecycle', 'nav.auftrag': 'Order-to-cash', 'nav.anlagen': 'Asset lifecycle', 'nav.lieferant': 'Supplier lifecycle', 'nav.marketing': 'Marketing & analytics', 'nav.marketingkarte': 'Marketing maps', 'nav.gutschriften': 'Credit notes & returns', 'nav.vertriebkpi': 'Sales metrics', 'nav.prozesskette': 'Funnel order → revenue', 'nav.portfoliobcg': 'Portfolio matrix (BCG)', 'nav.versand': 'Shipping cockpit', 'nav.bestand': 'Inventory turnover', 'nav.forderungen': 'Receivables aging', 'nav.mitarbeiter': 'Employee lifecycle',
