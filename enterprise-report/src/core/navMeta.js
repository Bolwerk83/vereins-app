...
export const VIEW_BEREICH = {
  ...
  // Operativ
  marketing: 'MKT', marketingkarte: 'MKT', google: 'MKT', gutschriften: 'VC', vertriebkpi: 'VK', prozesskette: 'VK', events: 'MKT', bestand: 'SCC', lager: 'LOG', wms: 'LOG', produktion: 'PR', lieferant: 'EK', auftrag: 'VK', versand: 'LOG', forderungen: 'RIS',
  // Analyse & Steuerung
