  ...
  return (
    <div style={{ maxWidth: 1100, margin: '0 auto' }}>
      ...
      <div style={{ ...card, padding: 18, marginBottom: 16, borderLeft: `4px solid ${AMP[ampel(kGes.abwPct)]}`, background: 'linear-gradient(90deg, var(--bg), var(--panel))' }}>
        ...
        <div style={{ marginTop: 12 }}>
          <div style={cap}>Management-Summary</div>
          <textarea value={summe} onChange={(e) => { setSumme(e.target.value); speichereBemerkung('summary', e.target.value) }} rows={2}
            placeholder="Zusammenfassende Einordnung für die Geschäftsführung …"
