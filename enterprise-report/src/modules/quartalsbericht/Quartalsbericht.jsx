...
// Automatische, regelbasierte Management-Summary (ohne KI) mit Vorlagen, die
// je nach Ergebnislage unterschiedlich formulieren.
function AutoSummary({ monate, faktor, periodeName, pcLabel, onUebernehmen }) {
  ...
  return (
    <div className="no-print" style={{ ...card, padding: 14, marginBottom: 12, borderLeft: `4px solid ${AMP[s.status]}` }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 10, flexWrap: 'wrap', marginBottom: 8 }}>
        <span style={{ ...cap, color: 'var(--accent)' }}>✨ Auto-Summary <span style={{ color: 'var(--muted)', fontWeight: 400, textTransform: 'none' }}>· aus den Zahlen abgeleitet, ohne KI</span></span>
        <span style={{ display: 'inline-flex', gap: 6, alignItems: 'center' }}>
          ...
          <button onClick={() => onUebernehmen(text)} style={{ ...sel, border: 'none', background: 'var(--accent)', color: '#fff', fontWeight: 600 }}>In Summary übernehmen ↓</button>
        </span>
      </div>
