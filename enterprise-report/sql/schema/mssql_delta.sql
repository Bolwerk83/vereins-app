...
WHEN MATCHED THEN UPDATE SET T.BestandMenge = S.BestandMenge, T.Bestandswert = S.Bestandswert, T.ReichweiteTage = S.ReichweiteTage, T.QuelleSystem = S.QuelleSystem, T.LadeBatchKey = S.LadeBatchKey, T.AktualisiertAm = S.AktualisiertAm
WHEN NOT MATCHED THEN INSERT (BestandKey, DatumKey, StandortKey, ProduktKey, BestandMenge, Bestandswert, ReichweiteTage, QuelleSystem, LadeBatchKey, AktualisiertAm) VALUES (S.BestandKey, S.DatumKey, S.StandortKey, S.ProduktKey, S.BestandMenge, S.Bestandswert, S.ReichweiteTage, S.QuelleSystem, S.LadeBatchKey, S.AktualisiertAm);
...
WHEN NOT MATCHED THEN INSERT (ForderungKey, BelegNr, StichtagKey, KundeKey, FaelligkeitKey, OffenerBetrag, TageUeberfaellig, Mahnstufe, ErwarteterAusfall, QuelleSystem, LadeBatchKey, AktualisiertAm) VALUES (S.ForderungKey, S.BelegNr, S.StichtagKey, S.KundeKey, S.FaelligkeitKey, S.OffenerBetrag, S.TageUeberfaellig, S.Mahnstufe, S.ErwarteterAusfall, S.QuelleSystem, S.LadeBatchKey, S.AktualisiertAm);
...
WHEN MATCHED THEN UPDATE SET T.FaelligDatumKey = S.FaelligDatumKey, T.Richtung = S.Richtung, T.Kategorie = S.Kategorie, T.Betrag = S.Betrag, T.IstProg = S.IstProg, T.QuelleSystem = S.QuelleSystem, T.LadeBatchKey = S.LadeBatchKey, T.AktualisiertAm = S.AktualisiertAm
WHEN NOT MATCHED THEN INSERT (ZahlungKey, Referenz, FaelligDatumKey, Richtung, Kategorie, Betrag, IstProg, QuelleSystem, LadeBatchKey, AktualisiertAm) VALUES (S.ZahlungKey, S.Referenz, S.FaelligDatumKey, S.Richtung, S.Kategorie, S.Betrag, S.IstProg, S.QuelleSystem, S.LadeBatchKey, S.AktualisiertAm);
...
WHEN MATCHED THEN UPDATE SET T.Besucher = S.Besucher, T.Kaeufe = S.Kaeufe, T.Umsatz = S.Umsatz, T.QuelleSystem = S.QuelleSystem, T.LadeBatchKey = S.LadeBatchKey, T.AktualisiertAm = S.AktualisiertAm
WHEN NOT MATCHED THEN INSERT (BesuchKey, DatumKey, Stunde, StandortKey, Besucher, Kaeufe, Umsatz, QuelleSystem, LadeBatchKey, AktualisiertAm) VALUES (S.BesuchKey, S.DatumKey, S.Stunde, S.StandortKey, S.Besucher, S.Kaeufe, S.Umsatz, S.QuelleSystem, S.LadeBatchKey, S.AktualisiertAm);
...
WHEN MATCHED THEN UPDATE SET T.Sitzungen = S.Sitzungen, T.Nutzer = S.Nutzer, T.NeueNutzer = S.NeueNutzer, T.Seitenaufrufe = S.Seitenaufrufe, T.AbsprungProzent = S.AbsprungProzent, T.DauerSek = S.DauerSek, T.QuelleSystem = S.QuelleSystem, T.LadeBatchKey = S.LadeBatchKey, T.AktualisiertAm = S.AktualisiertAm
WHEN NOT MATCHED THEN INSERT (WebSessionKey, DatumKey, KanalKey, Geraet, Sitzungen, Nutzer, NeueNutzer, Seitenaufrufe, AbsprungProzent, DauerSek, QuelleSystem, LadeBatchKey, AktualisiertAm) VALUES (S.WebSessionKey, S.DatumKey, S.KanalKey, S.Geraet, S.Sitzungen, S.Nutzer, S.NeueNutzer, S.Seitenaufrufe, S.AbsprungProzent, S.DauerSek, S.QuelleSystem, S.LadeBatchKey, S.AktualisiertAm);
...
WHEN NOT MATCHED THEN INSERT (WebFunnelKey, DatumKey, KanalKey, Sitzungen, Produktansichten, WarenkorbAdds, CheckoutStarts, Kaeufe, Umsatz, SucheOhneTreffer, QuelleSystem, LadeBatchKey, AktualisiertAm) VALUES (S.WebFunnelKey, S.DatumKey, S.KanalKey, S.Sitzungen, S.Produktansichten, S.WarenkorbAdds, S.CheckoutStarts, S.Kaeufe, S.Umsatz, S.SucheOhneTreffer, S.QuelleSystem, S.LadeBatchKey, S.AktualisiertAm);
...
WHEN MATCHED THEN UPDATE SET T.StandortKey = S.StandortKey, T.KalenderId = S.KalenderId, T.Planwert = S.Planwert, T.QuelleSystem = S.QuelleSystem, T.LadeBatchKey = S.LadeBatchKey, T.AktualisiertAm = S.AktualisiertAm
WHEN NOT MATCHED THEN INSERT (PlanKey, KPIKey, Jahr, Monat, StandortKey, KalenderId, Planwert, QuelleSystem, LadeBatchKey, AktualisiertAm) VALUES (S.PlanKey, S.KPIKey, S.Jahr, S.Monat, S.StandortKey, S.KalenderId, S.Planwert, S.QuelleSystem, S.LadeBatchKey, S.AktualisiertAm);
...
WHEN MATCHED THEN UPDATE SET T.Wert = S.Wert, T.QuelleSystem = S.QuelleSystem, T.LadeBatchKey = S.LadeBatchKey, T.AktualisiertAm = S.AktualisiertAm
WHEN NOT MATCHED THEN INSERT (KPIWertKey, KPIKey, Periode, Dimension, Wert, QuelleSystem, LadeBatchKey, AktualisiertAm) VALUES (S.KPIWertKey, S.KPIKey, S.Periode, S.Dimension, S.Wert, S.QuelleSystem, S.LadeBatchKey, S.AktualisiertAm);
